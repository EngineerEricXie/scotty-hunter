...
const DEMO_SEEDS: Seed[] = [
  ...
  {
    id: "demo-mon-box-lunch",
    source_id: "scottybites-demo-seed",
    source_type: "department",
    title: "HCI lunch seminar",
    description: "Monday seminar. Boxed sandwiches will be provided. Vegetarian options available.",
    organizer: "HCII",
    date: "2026-09-14",
    start: [12, 0],
    end: [13, 0],
    ...
    food_confidence: 0.96,
    food_evidence: "Boxed sandwiches will be provided. Vegetarian options available.",
    event_types: ["talk"],
    provenance_note: "Week-plan Monday lunch seed.",
  },
  {
    id: "demo-mon-indian-dinner",
    source_id: "scottybites-demo-seed",
    source_type: "student_org",
    title: "South Asian Student Association dinner",
    description: "Indian dinner will be served.",
    organizer: "SASA",
    date: "2026-09-14",
    start: [18, 0],
    end: [19, 30],
    ...
    food_confidence: 0.95,
    food_evidence: "Indian dinner will be served.",
    event_types: ["social"],
    provenance_note: "Week-plan Monday dinner seed.",
  },
  {
    id: "demo-wed-veg-pizza",
    source_id: "scottybites-demo-seed",
    source_type: "department",
    title: "Machine Learning Seminar",
    description: "Wednesday lunch. Vegetarian pizza will be provided.",
    organizer: "Machine Learning Department",
    date: "2026-09-16",
    start: [12, 0],
    end: [13, 0],
    venue: "Tepper 1403",
    food_status: "EXPLICIT",
    food_types: ["lunch", "pizza"],
    food_items: ["pizza"],
    dietary_tags: ["vegetarian"],
    food_confidence: 0.98,
    food_evidence: "Vegetarian pizza will be provided.",
    event_types: ["talk"],
    provenance_note: "Hero Wednesday lunch seed.",
  },
  {
    id: "demo-wed-steak",
    source_id: "scottybites-demo-seed",
    ...
    description: "Meat-only BBQ lunch for faculty and invited guests.",
    organizer: "Faculty Senate",
    date: "2026-09-16",
    start: [12, 0],
    end: [13, 0],
    venue: "Wean Hall 7500",
    food_status: "EXPLICIT",
    food_types: ["lunch"],
    dietary_tags: ["meat"],
    food_confidence: 0.97,
    ...
    event_types: ["talk"],
    provenance_note: "Vegetarian hard-filter seed.",
  },
  {
    id: "demo-wed-asian-mixer",
    source_id: "scottybites-demo-seed",
    source_type: "student_org",
    title: "Startup Networking Night",
    description: "Asian catering will be served. Registration required.",
    organizer: "Swartz Center",
    date: "2026-09-16",
    start: [17, 30],
    end: [19, 0],
    venue: "CUC Rangos",
    food_status: "EXPLICIT",
    food_types: ["dinner", "catering"],
    cuisine_tags: ["Asian"],
    food_confidence: 0.92,
    food_evidence: "Asian catering will be served.",
    registration_required: true,
    registration_url: "https://example.org/startup-night-rsvp",
    registration_deadline: zonedWallTimeToIso(2026, 9, 15, 23, 59),
    event_types: ["mixer"],
    provenance_note: "Hero Wednesday dinner + RSVP-by-Tuesday seed.",
  },
  {
    id: "demo-fri-policy-lunch",
    source_id: "scottybites-demo-seed",
    source_type: "department",
    title: "Friday public-policy lunch",
    ...
    food_evidence: "Lunch will be provided.",
    event_types: ["talk"],
    provenance_note: "Week-plan Friday lunch seed.",
  },
  {
    id: "demo-fri-google-dinner",
    source_id: "scottybites-demo-seed",
    source_type: "company_event",
    title: "Google AI Talk dinner",
    description: "Free dinner. Registration required. Vegetarian options available.",
    organizer: "Google",
    date: "2026-09-18",
    start: [18, 0],
    end: [19, 30],
    ...
    dietary_tags: ["vegetarian"],
    food_confidence: 0.97,
    food_evidence: "Free dinner. Vegetarian options available.",
    registration_required: true,
    registration_url: "https://example.org/google-ai-rsvp",
    registration_deadline: zonedWallTimeToIso(2026, 9, 13, 18, 0),
    event_types: ["talk"],
    provenance_note: "Friday dinner whose RSVP closes tomorrow relative to demo date 2026-09-12.",
  },
];
